<?php
	$pagesData = [
		"about" => [
			...
			"body" => "<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, obcaecati sequi! Sint soluta velit maiores, neque qui accusantium voluptatum veritatis consequatur iste quae reprehenderit inventore facilis. Veniam odit neque odio culpa consequuntur, nemo rem. Cupiditate nemo magni id quibusdam omnis incidunt!<br /> Ullam praesentium nam nesciunt repellendus expedita accusamus consequatur. Nemo est ex enim facere fugit dignissimos consequatur adipisci perferendis quibusdam expedita illo, optio labore sunt nisi error laborum consectetur cumque quas magni voluptatem iure deserunt! Autem aut atque ipsum eum velit?<br /> Modi voluptatum nisi minus, cum, suscipit, nostrum at obcaecati exercitationem alias maxime maiores blanditiis beatae omnis dicta magni quod.</p>",
			"image" => "<img src=\"./images/team.jpg\" alt=\"Team\""
		],
		...
		"blog" => [
			...
			"body" => [
				"article_1" => [
					...
					"image" => "<img src=\"./images/toronto.webp\" alt=\"Toronto\">"
				],
				"article_2" => [
					"name" => "<h3>Startup News & Emerging Tech</h3>",
					"content" => "<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, iusto doloribus eveniet cumque facere tenetur laborum est perferendis sint, fugit eaque quasi explicabo consequatur, ratione maiores voluptates nemo architecto deleniti deserunt officia numquam pariatur. Quos facilis libero, nisi ut quasi, pariatur consequuntur aut fuga hic vel molestias, distinctio veritatis neque!</p>",
					"image" => "<img src=\"./images/startup_news.png\" alt=\"Startup news\">"
				],
				"article_3" => [
					"name" => "<h3>Bitcoin Will Soon Rule The World</h3>",
					"content" => "<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, iusto doloribus eveniet cumque facere tenetur laborum est perferendis sint, fugit eaque quasi explicabo consequatur, ratione maiores voluptates nemo architecto deleniti deserunt officia numquam pariatur. Quos facilis libero, nisi ut quasi, pariatur consequuntur aut fuga hic vel molestias, distinctio veritatis neque!</p>",
					"image" => "<img src=\"./images/btc.jpg\" alt=\"Bitcoin\">"
				],
				"article_4" => [
					"name" => "<h3>Wearable Technology On The Rise</h3>",
					"content" => "<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, iusto doloribus eveniet cumque facere tenetur laborum est perferendis sint, fugit eaque quasi explicabo consequatur, ratione maiores voluptates nemo architecto deleniti deserunt officia numquam pariatur. Quos facilis libero, nisi ut quasi, pariatur consequuntur aut fuga hic vel molestias, distinctio veritatis neque!</p>",
					"image" => "<img src=\"./images/wearable_technology.jpg\" alt=\"Wearable technology\">"
				],
				"article_5" => [
					"name" => "<h3>Learn Web Design In 30 Days!</h3>",
					"content" => "<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, iusto doloribus eveniet cumque facere tenetur laborum est perferendis sint, fugit eaque quasi explicabo consequatur, ratione maiores voluptates nemo architecto deleniti deserunt officia numquam pariatur. Quos facilis libero, nisi ut quasi, pariatur consequuntur aut fuga hic vel molestias, distinctio veritatis neque!</p>",
					"image" => "<img src=\"./images/learn_web_design.jpg\" alt=\"Learn web design.jpg\">"
				],
			]
		],
		...
		"contact" => [
			...
			"body" => [
				"name" => "<input required placeholder=\"Ivan\" type=\"text\" minlength=\"2\" maxlength=\"50\" name=\"name\" />",
				"phone" => "<input required placeholder=\"+375 (29) 111-22-33\" type=\"tel\" name=\"phone\">",
				"email" => "<input required placeholder=\"myemail@gmail.com\" type=\"email\" name=\"email\">",
